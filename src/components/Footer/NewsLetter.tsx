...
const Newsletter: React.FC<NewsletterProps> = ({ onSubmit }) => {
  ...
  return (
    <div>
      ...
      <div className='flex'>
        <div className='text-base flex border border-gray-400 overflow-hidden w-67 '>
          <input
            type='text'
            placeholder='E-MAIL'
            className='px-3 py-3 w-full outline-none font-semibold'
          />
          <button type='submit' className='px-2 text-2xl'>
            <IoIosArrowForward />
          </button>
        </div>
      </div>
